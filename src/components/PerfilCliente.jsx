            ...
            <div className="w-full md:w-1/3 lg:w-1/4">
              <div className="p-6 mb-6 text-center bg-white border border-gray-100 rounded-lg shadow-sm">
                <div className="relative w-32 h-32 mx-auto mb-4">
                  <img
                    src={perfil.candidato.imagen}
                    alt={`${perfil.candidato.nombre} ${perfil.candidato.apellido}`}
                ...
                <h1 className="mb-1 text-xl font-bold">
                  {perfil.candidato.nombre} {perfil.candidato.apellido}
                </h1>
                <p className="mb-2 font-medium text-blue-600">{perfil.candidato.estudio}</p>
